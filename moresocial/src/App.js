...
// import { share } from '@fortawesome/fontawesome-common-types'
    ...
    return (
      	<div className="App" style={{ height: '100vh' }}>
		  	<div style={{ position: 'fixed'}} className="background">
			  	<Granim direction="left-right" direction="diagonal" states={granim_gradient_options} customDirection={granim_direction_options} />
